...
from karigar_shared.notifications import notify_demand_created, notify_demand_resolved
...
async def create_demand_request(
    ...
    *,
    ...
    await notify_demand_created(session, demand=result)
    return result
...
async def update_demand_request(
    ...
    *,
    ...
    await notify_demand_resolved(session, demand=demand)
    return demand

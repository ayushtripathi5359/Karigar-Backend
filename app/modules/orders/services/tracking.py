"""order_tracking + inventory_log writers — single ownership."""
...
async def log_status(
    ...
    *,
    ...
    """One row in order_tracking per status transition."""
...
async def record_purchase(
    ...
    *,
    ...
    """Inventory event when an order confirms successfully."""
    await session.execute(
        text(
            """
